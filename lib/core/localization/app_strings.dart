...
class AppStrings {
  ...
  static String get noResults => isArabic ? 'لا توجد نتائج' : 'No results found';
  static String get noResultsDesc => isArabic ? 'حاول تعديل معايير البحث' : 'Try adjusting your search criteria';
  static String get openInMaps => isArabic ? 'فتح في خرائط جوجل' : 'Open in Google Maps';
  ...
  static String get noReviews => isArabic ? 'لا توجد تقييمات مكتوبة بعد' : 'No written reviews yet';
  ...
  static String get resetPassword => isArabic ? 'إعادة تعيين كلمة المرور' : 'Reset Password';
  static String get sendResetLink => isArabic ? 'إرسال رابط إعادة التعيين' : 'Send Reset Link';
  static String get otp => isArabic ? 'رمز التحقق' : 'OTP';
  static String get verifyOtp => isArabic ? 'تأكيد رمز التحقق' : 'Verify OTP';
  static String get profileInfo => isArabic ? 'معلومات الملف الشخصي' : 'Profile Information';
  ...
  static String get loginRequired => isArabic ? 'يجب تسجيل الدخول للتواصل' : 'You must log in to contact';
  static String get loginToContact => isArabic ? 'تسجيل الدخول للتواصل' : 'Log in to contact';
  static String get verifyRequired => isArabic ? 'يرجى توثيق الحساب أولاً' : 'Please verify your account first';
  static String get verifyAccountPrompt => isArabic ? 'عذراً، يجب تسجيل الدخول وتوثيق الحساب أولاً\nلاتخاذ هذا الإجراء.' : 'Sorry, you must log in and verify\nyour account to proceed.';
  ...
  static String get noProperties => isArabic ? 'لا توجد عقارات' : 'No properties available';

  // ── Property Detail ──
  static String get propertyInfo => isArabic ? 'معلومات العقار' : 'Property Info';
  static String get aboutProperty => isArabic ? 'عن العقار' : 'About this property';
  static String get noDescription => isArabic ? 'لا يوجد وصف متاح' : 'No description available.';
  ...
  static String get installmentCalc => isArabic ? 'حاسبة الأقساط' : 'Installment Calculator';
  static String get downPayment => isArabic ? 'المقدم' : 'Down Payment';
  static String get numberOfYears => isArabic ? 'عدد السنوات' : 'Number of Years';
  static String get monthlyPayment => isArabic ? 'الدفعة الشهرية' : 'Monthly Payment';
  static String get totalPayment => isArabic ? 'الدفعة الكلية' : 'Total Payment';
  ...
  static String get contactOwner => isArabic ? 'تواصل مع المالك' : 'Contact Owner';
  ...
  static String get promote => isArabic ? 'ترقية العقار (250 ج.م)' : 'Promote (250 EGP)';
  static String get unlist => isArabic ? 'إلغاء النشر' : 'Unlist';
  static String get unlistConfirm => isArabic ? 'هل أنت متأكد من إلغاء نشر هذا العقار؟' : 'Are you sure you want to unlist this property?';
  static String get deleteConfirm => isArabic ? 'هل أنت متأكد من حذف هذا العقار؟ لا يمكن التراجع عن هذا الإجراء.' : 'Are you sure you want to delete this property? This cannot be undone.';
  static String get sold => isArabic ? 'تم البيع' : 'Sold';
  static String get rented => isArabic ? 'تم التأجير' : 'Rented';
  static String get propertyUnavailable => isArabic ? 'هذا العقار غير متاح حالياً' : 'This property is currently unavailable';
  ...
  static String get sendRentRequest => isArabic ? 'إرسال طلب إيجار' : 'Send Rent Request';
  ...
  static String get noFavorites => isArabic ? 'لا توجد مفضلة بعد' : 'No favorites yet.';
  static String get noFavoritesDesc => isArabic ? 'ابدأ بإضافة العقارات التي تعجبك!' : 'Start adding properties you like!';

  // ── Profile ──
  static String get myProperty => isArabic ? 'عقاراتي' : 'My Property';
  static String get myPropertySub => isArabic ? 'عقاراتي المسجلة' : 'My saved listings';
  static String get myRequest => isArabic ? 'طلباتي' : 'My Requests';
  static String get myRequestSub => isArabic ? 'عرض طلبات الإيجار المرسلة والمستلمة' : 'View sent & received requests';
  static String get invoices => isArabic ? 'الفواتير' : 'Invoices';
  static String get invoicesSub => isArabic ? 'عرض فواتيرك' : 'View your invoices';
  static String get wallet => isArabic ? 'المحفظة' : 'Wallet';
  static String get walletSub => isArabic ? 'عرض المحفظة والمعاملات' : 'View wallet & transactions';
  static String get myChats => isArabic ? 'محادثاتي' : 'My Chats';
  static String get myChatsSub => isArabic ? 'رسائل مع الملاك والمستأجرين' : 'Messages with owners & tenants';
  static String get contactUs => isArabic ? 'اتصل بنا' : 'Contact Us';
  static String get contactUsSub => isArabic ? 'أرسل لنا بريداً إلكترونياً' : 'Send us an email';

  // ── Add Property ──
  static String get addProperty => isArabic ? 'إضافة عقار' : 'Add Property';
  static String get editPropertyTitle => isArabic ? 'تعديل العقار' : 'Edit Property';
  static String get propertyName => isArabic ? 'اسم العقار' : 'Property Name';
  static String get propertyDesc => isArabic ? 'وصف العقار' : 'Property Description';
  ...
  static String get physicalTypeHint => isArabic ? 'اختر نوع العقار' : 'Select property type';
  static String get listingTypeLabel => isArabic ? 'نوع الإعلان' : 'Listing Type';
  static String get pricing => isArabic ? 'السعر' : 'Pricing';
  static String get pricingUnitLabel => isArabic ? 'وحدة السعر' : 'Pricing Unit';
  ...
  static String get pricePerDayLabel => isArabic ? 'السعر لليوم' : 'Price per Day';
  static String get photos => isArabic ? 'الصور' : 'Photos';
  static String get addPhotos => isArabic ? 'إضافة صور' : 'Add Photos';
  static String get ownershipProof => isArabic ? 'مستندات الملكية' : 'Ownership Documents';
  static String get basicInfo => isArabic ? 'المعلومات الأساسية' : 'Basic Information';
  ...
  // ── Sponsor / Payment ──
  static String get promoteProperty => isArabic ? 'ترقية العقار' : 'Promote Property';
  ...
  static String get paymentSuccess => isArabic ? 'تمت عملية الدفع بنجاح' : 'Payment successful';
  static String get paymentFailed => isArabic ? 'فشلت عملية الدفع' : 'Payment failed';
  static String get transactionId => isArabic ? 'رقم العملية' : 'Transaction ID';
  ...
  static String get paymentPending => isArabic ? 'في انتظار الدفع' : 'Payment Pending';
  static String get paid => isArabic ? 'مدفوع' : 'Paid';

  // ── Search / Filter ──
  static String get searchProperties => isArabic ? 'بحث في العقارات' : 'Search Properties';
  static String get searchHint => isArabic ? 'ابحث بالموقع...' : 'Search by location...';
  ...
  // ── Chat ──
  static String get typeMessage => isArabic ? 'اكتب رسالة...' : 'Type a message...';
  static String get send => isArabic ? 'إرسال' : 'Send';
  static String get noMessages => isArabic ? 'لا توجد رسائل بعد' : 'No messages yet';
  static String get startChatting => isArabic ? 'ابدأ المحادثة' : 'Start chatting';

  // ── AI Assistant ──
  static String get aiAssistant => isArabic ? 'المساعد الذكي' : 'AI Assistant';
  static String get askQuestion => isArabic ? 'اسأل سؤالاً...' : 'Ask a question...';

  // ── Errors ──
  static String get failedToLoad => isArabic ? 'فشل في تحميل البيانات' : 'Failed to load data';
  static String get failedToLoadProperty => isArabic ? 'فشل في تحميل تفاصيل العقار' : 'Failed to load property details';
  static String get failedToLoadFavorites => isArabic ? 'فشل في تحميل المفضلة' : 'Failed to load favorites';
  static String get networkError => isArabic ? 'خطأ في الاتصال بالشبكة' : 'Network error';
  static String get pleaseTryAgain => isArabic ? 'يرجى المحاولة مرة أخرى' : 'Please try again';
  static String get somethingWentWrong => isArabic ? 'حدث خطأ ما' : 'Something went wrong';
}
