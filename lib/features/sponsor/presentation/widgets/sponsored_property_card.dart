  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double infoFontSize = (cardWidth < 180 ? 9.0 : 10.0) * compactScale;
        final double iconSize = (cardWidth < 180 ? 12.0 : 14.0) * compactScale;
        final double gapScale = compactScale;
                            ...
                            Flexible(
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  color:
                                      isSponsored ? _gold : AppColors.primary,
                                ),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ...
                            ? Wrap(
                                ...
                                children: [
                                  _infoItem(Icons.bed_outlined,
                                      '${property.bedroomsNo}', iconSize, infoFontSize),
                                  _infoItem(Icons.bathtub_outlined,
                                      '${property.bathroomsNo}', iconSize, infoFontSize),
                                  _infoItem(Icons.square_foot_outlined,
                                      property.size, iconSize, infoFontSize),
                                ],
                              )
                            : Row(
                                mainAxisAlignment:
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: (9 * compactScale).clamp(7, 9),
                                fontWeight: FontWeight.w700,
                                color: property.status.color,
                              ),
                            ),
